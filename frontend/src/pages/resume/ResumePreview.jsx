...
//       const response = await fetch("https://career-forage.onrender.com/api/resumes", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
    ...
    const generatePdf = async () => {
      ...
      try {
        ...
        const safeResumeData = {
          ...
          professionalSummary:
            resumeData.professionalSummary ||
            "Enthusiastic developer passionate about building impactful solutions.",
        };

        const element = <TemplateComponent data={safeResumeData} />;
        const blob = await pdf(element).toBlob();
    ...
    <div className="space-y-6 text-sm">
      ...
      {resumeData.professionalSummary && (
        <div>
          ...
          <p className="whitespace-pre-line">{resumeData.professionalSummary}</p>
        </div>
      )}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {renderedTemplate && (
          <div className="hidden sm:block mb-12">
            <PDFViewer width="100%" height={800} className="w-full border rounded-lg">
              {renderedTemplate}
            </PDFViewer>
          </div>
        )}
        ...
        {/* Mobile Fallback */}
        <div className="block sm:hidden bg-white shadow p-4 rounded-lg mb-8">
          {renderWebTemplate()}
        </div>
